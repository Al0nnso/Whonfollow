...
module.exports = {
    ...
    async regist(req,res){
        ...
        const api_url = 'https://api.instagram.com/oauth/access_token'
        var redirect_uri=process.env.APP_URL+"/api/auth"
        const body='client_id='+process.env.PUBLIC_ID+';client_secret='+process.env.SECRET_KEY;+';grant_type=authorization_code;redirect_uri='+redirect_uri+';code='+code
        //console.log(body)
        ...
        request.post({
                ...
                request(longtoken_url, async function (error, response, body) {
                    ...
                    return res.redirect(process.env.APP_URL+"/whonfollow-pages/")
                })
        });
